...
function webAPI_HEAD(successCallBack, errorCallBack) {
    $.ajax({
        ...
        complete: function(request) { 
            console.log("News etag: " + request.getResponseHeader('ETag'));
...
function webAPI_GET_ALL(queryString, successCallBack, errorCallBack, addToTheEnd = false) {
    $.ajax({
        ...
        success: (data, status, xhr) => { 
            ...
            successCallBack(data, ETag, addToTheEnd);
            console.log("webAPI_GET_ALL - success", data); 
            console.log(`Users etag: ${ETag}`);
        },
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("webAPI_GET_ALL - error");
...
function webAPI_GET_ALL_User(successCallBack, errorCallBack) {
    $.ajax({
        ...
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("webAPI_GET_ALL_User - error");
        }
    });
}
function webAPI_HEAD_Users(successCallBack, errorCallBack) {
    $.ajax({
        url: apiBaseURL + "/api/accounts",
        type: 'HEAD',
        contentType:'text/plain',
        complete: function(request) {
            console.log("webAPI_HEAD_Users: " + request.getResponseHeader('ETag'));
            successCallBack(request.getResponseHeader('ETag'));},
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("webAPI_GET_ALL - error");
